...
% visualizing original and background equalized videos
for i=1:nFrames
    Frames2(:,:,i) = [reshape(dataset(i,:)+Mean,nRows,nColumns) ...
...
%% Reconstructing the original video from the extracted shapes and coordinates
...
% NOTE THAT ONLY THESE TWO MATRICES ARE NEEDED TO RECONSTRUCT THE WHOLE 
% MOTION IN THE VIDEO
...
% reshaping, rescaling and re-building frames
for j=1:nFrames
...
whos ('mode_shapes', 'modal_coord', 'Frames')
[obj]=whos ('mode_shapes', 'modal_coord', 'Frames')
% obj.bytes

compression_rate = 1-(19200+3981312)/265420800
